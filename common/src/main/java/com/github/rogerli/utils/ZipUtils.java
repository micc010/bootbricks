...
public class ZipUtils {
     ...
     */
    public static boolean zipFiles(final List<String> srcFiles,
     ...
     * @throws IOException if an I/O error has occurred
     */
    public static boolean zipFiles(final List<String> srcFilePaths,
                                   final String zipFilePath,
     ...
     * @throws IOException if an I/O error has occurred
     */
    public static boolean zipFiles(final List<File> srcFiles, final File zipFile)
            throws IOException {
     ...
     * @throws IOException if an I/O error has occurred
     */
    public static boolean zipFiles(final List<File> srcFiles,
                                   final File zipFile,
                                   final String comment)
            throws IOException {
    ...
    public static void main(String[] args) throws Exception {
        ...
        list.add(new File("C:\\TEMP\\test11\\新建文件夹\\test"));
        list.add(new File("C:\\TEMP\\test11\\新建文件夹"));
        zipFiles(list, new File("C:\\TEMP\\test33.zip"));
    }

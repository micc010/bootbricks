...
public class EncryptUtils {
     ...
     * @return the hex string of MD2 encryption
     */
    public String encryptMD2ToString(final String data) {
     ...
     * @return the hex string of MD2 encryption
     */
    public String encryptMD2ToString(final byte[] data) {
     ...
     * @return the bytes of MD2 encryption
     */
    public byte[] encryptMD2(final byte[] data) {
     ...
     * @return the hex string of MD5 encryption
     */
    public String encryptMD5ToString(final String data) {
        if (data == null || data.length() == 0) return "";
     ...
     * @return the hex string of MD5 encryption
     */
    public String encryptMD5ToString(final String data, final String salt) {
     ...
     * @return the hex string of MD5 encryption
     */
    public String encryptMD5ToString(final byte[] data) {
     ...
     * @return the hex string of MD5 encryption
     */
    public String encryptMD5ToString(final byte[] data, final byte[] salt) {
        if (data == null && salt == null) return "";
     ...
     * @return the bytes of MD5 encryption
     */
    public byte[] encryptMD5(final byte[] data) {
     ...
     * @return the hex string of file's MD5 encryption
     */
    public String encryptMD5File2String(final String filePath) {
     ...
     * @return the bytes of file's MD5 encryption
     */
    public byte[] encryptMD5File(final String filePath) {
        File file = isSpace(filePath) ? null : new File(filePath);
     ...
     * @return the hex string of file's MD5 encryption
     */
    public String encryptMD5File2String(final File file) {
     ...
     * @return the bytes of file's MD5 encryption
     */
    public byte[] encryptMD5File(final File file) {
     ...
     * @return the hex string of SHA1 encryption
     */
    public String encryptSHA1ToString(final String data) {
        if (data == null || data.length() == 0) return "";
     ...
     * @return the hex string of SHA1 encryption
     */
    public String encryptSHA1ToString(final byte[] data) {
     ...
     * @return the bytes of SHA1 encryption
     */
    public byte[] encryptSHA1(final byte[] data) {
     ...
     * @return the hex string of SHA224 encryption
     */
    public String encryptSHA224ToString(final String data) {
        if (data == null || data.length() == 0) return "";
     ...
     * @return the hex string of SHA224 encryption
     */
    public String encryptSHA224ToString(final byte[] data) {
     ...
     * @return the bytes of SHA224 encryption
     */
    public byte[] encryptSHA224(final byte[] data) {
     ...
     * @return the hex string of SHA256 encryption
     */
    public String encryptSHA256ToString(final String data) {
        if (data == null || data.length() == 0) return "";
     ...
     * @return the hex string of SHA256 encryption
     */
    public String encryptSHA256ToString(final byte[] data) {
     ...
     * @return the bytes of SHA256 encryption
     */
    public byte[] encryptSHA256(final byte[] data) {
     ...
     * @return the hex string of SHA384 encryption
     */
    public String encryptSHA384ToString(final String data) {
        if (data == null || data.length() == 0) return "";
     ...
     * @return the hex string of SHA384 encryption
     */
    public String encryptSHA384ToString(final byte[] data) {
     ...
     * @return the bytes of SHA384 encryption
     */
    public byte[] encryptSHA384(final byte[] data) {
     ...
     * @return the hex string of SHA512 encryption
     */
    public String encryptSHA512ToString(final String data) {
        if (data == null || data.length() == 0) return "";
     ...
     * @return the hex string of SHA512 encryption
     */
    public String encryptSHA512ToString(final byte[] data) {
     ...
     * @return the bytes of SHA512 encryption
     */
    public byte[] encryptSHA512(final byte[] data) {
     ...
     * @return the hex string of HmacMD5 encryption
     */
    public String encryptHmacMD5ToString(final String data, final String key) {
     ...
     * @return the hex string of HmacMD5 encryption
     */
    public String encryptHmacMD5ToString(final byte[] data, final byte[] key) {
     ...
     * @return the bytes of HmacMD5 encryption
     */
    public byte[] encryptHmacMD5(final byte[] data, final byte[] key) {
     ...
     * @return the hex string of HmacSHA1 encryption
     */
    public String encryptHmacSHA1ToString(final String data, final String key) {
        if (data == null || data.length() == 0 || key == null || key.length() == 0) return "";
     ...
     * @return the hex string of HmacSHA1 encryption
     */
    public String encryptHmacSHA1ToString(final byte[] data, final byte[] key) {
     ...
     * @return the bytes of HmacSHA1 encryption
     */
    public byte[] encryptHmacSHA1(final byte[] data, final byte[] key) {
     ...
     * @return the hex string of HmacSHA224 encryption
     */
    public String encryptHmacSHA224ToString(final String data, final String key) {
        if (data == null || data.length() == 0 || key == null || key.length() == 0) return "";
     ...
     * @return the hex string of HmacSHA224 encryption
     */
    public String encryptHmacSHA224ToString(final byte[] data, final byte[] key) {
     ...
     * @return the bytes of HmacSHA224 encryption
     */
    public byte[] encryptHmacSHA224(final byte[] data, final byte[] key) {
     ...
     * @return the hex string of HmacSHA256 encryption
     */
    public String encryptHmacSHA256ToString(final String data, final String key) {
        if (data == null || data.length() == 0 || key == null || key.length() == 0) return "";
     ...
     * @return the hex string of HmacSHA256 encryption
     */
    public String encryptHmacSHA256ToString(final byte[] data, final byte[] key) {
     ...
     * @return the bytes of HmacSHA256 encryption
     */
    public byte[] encryptHmacSHA256(final byte[] data, final byte[] key) {
     ...
     * @return the hex string of HmacSHA384 encryption
     */
    public String encryptHmacSHA384ToString(final String data, final String key) {
        if (data == null || data.length() == 0 || key == null || key.length() == 0) return "";
     ...
     * @return the hex string of HmacSHA384 encryption
     */
    public String encryptHmacSHA384ToString(final byte[] data, final byte[] key) {
     ...
     * @return the bytes of HmacSHA384 encryption
     */
    public byte[] encryptHmacSHA384(final byte[] data, final byte[] key) {
     ...
     * @return the hex string of HmacSHA512 encryption
     */
    public String encryptHmacSHA512ToString(final String data, final String key) {
        if (data == null || data.length() == 0 || key == null || key.length() == 0) return "";
     ...
     * @return the hex string of HmacSHA512 encryption
     */
    public String encryptHmacSHA512ToString(final byte[] data, final byte[] key) {
     ...
     * @return the bytes of HmacSHA512 encryption
     */
    public byte[] encryptHmacSHA512(final byte[] data, final byte[] key) {
     ...
     * @return the bytes of hmac encryption
     */
    private byte[] hmacTemplate(final byte[] data,
                                       final byte[] key,
     ...
     * @return the hex string of DES encryption
     */
    public String encryptDES2HexString(final byte[] data,
                                              final byte[] key,
     ...
     * @return the bytes of DES encryption
     */
    public byte[] encryptDES(final byte[] data,
                                    final byte[] key,
                                    final String transformation,
                                    final byte[] iv) {
     ...
     * @return the bytes of DES decryption for hex string
     */
    public byte[] decryptHexStringDES(final String data,
                                             final byte[] key,
                                             final String transformation,
                                             final byte[] iv) {
     ...
     * @return the bytes of DES decryption
     */
    public byte[] decryptDES(final byte[] data,
                                    final byte[] key,
                                    final String transformation,
                                    final byte[] iv) {
     ...
     * @return the hex string of 3DES encryption
     */
    public String encrypt3DES2HexString(final byte[] data,
                                               final byte[] key,
                                               final String transformation,
                                               final byte[] iv) {
     ...
     * @return the bytes of 3DES encryption
     */
    public byte[] encrypt3DES(final byte[] data,
                                     final byte[] key,
                                     final String transformation,
                                     final byte[] iv) {
     ...
     * @return the bytes of 3DES decryption for hex string
     */
    public byte[] decryptHexString3DES(final String data,
                                              final byte[] key,
                                              final String transformation,
                                              final byte[] iv) {
     ...
     * @return the bytes of 3DES decryption
     */
    public byte[] decrypt3DES(final byte[] data,
                                     final byte[] key,
                                     final String transformation,
                                     final byte[] iv) {
     ...
     * @return the hex string of AES encryption
     */
    public String encryptAES2HexString(final byte[] data,
                                              final byte[] key,
                                              final String transformation,
                                              final byte[] iv) {
     ...
     * @return the bytes of AES encryption
     */
    public byte[] encryptAES(final byte[] data,
                                    final byte[] key,
                                    final String transformation,
                                    final byte[] iv) {
     ...
     * @return the bytes of AES decryption for hex string
     */
    public byte[] decryptHexStringAES(final String data,
                                             final byte[] key,
                                             final String transformation,
                                             final byte[] iv) {
     ...
     * @return the bytes of AES decryption
     */
    public byte[] decryptAES(final byte[] data,
                                    final byte[] key,
                                    final String transformation,
                                    final byte[] iv) {
     ...
     * @return the bytes of symmetric encryption or decryption
     */
    private byte[] symmetricTemplate(final byte[] data,
                                            final byte[] key,
                                            final String algorithm,
                                            final String transformation,
                                            final byte[] iv,
     ...
     * @return the hex string of RSA encryption
     */
    public String encryptRSA2HexString(final byte[] data,
                                              final byte[] key,
     ...
     * @return the bytes of RSA encryption
     */
    public byte[] encryptRSA(final byte[] data,
                                    final byte[] key,
                                    final boolean isPublicKey,
                                    final String transformation) {
     ...
     * @return the bytes of RSA decryption for hex string
     */
    public byte[] decryptHexStringRSA(final String data,
                                             final byte[] key,
                                             final boolean isPublicKey,
                                             final String transformation) {
     ...
     * @return the bytes of RSA decryption
     */
    public byte[] decryptRSA(final byte[] data,
                                    final byte[] key,
                                    final boolean isPublicKey,
                                    final String transformation) {
     ...
     * @return the bytes of RSA encryption or decryption
     */
    private byte[] rsaTemplate(final byte[] data,
                                      final byte[] key,
                                      final boolean isPublicKey,
                                      final String transformation,
                                      final boolean isEncrypt) {
     ...
     * @return
     */
    private byte[] joins(final byte[] prefix, final byte[] suffix) {
     ...
     * @return
     */
    private int hex2Dec(final char hexChar) {
